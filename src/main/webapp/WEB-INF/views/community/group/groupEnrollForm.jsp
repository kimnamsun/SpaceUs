		...
		<div class="row m-5">
			<div class="col-12">
				...
				<div class="table-responsive">
					<form
						action="${pageContext.request.contextPath}/community/group/insertBoard.do"
						...
						<table class="table">
							<tr>
								...
								<th><select class="nice-select" name="boardNo" id="boardNo">
							...
							<tr>
								...
								<td><input type="text" name="groupBoardTitle"
									id="groupBoardTitle" placeholder="제목을 입력해주세요"
