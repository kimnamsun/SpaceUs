		...
		<div class="row m-5">
			<div class="col-12">
				...
				<div class="table-responsive">
					<form
						action="${pageContext.request.contextPath}/community/recruit/updateRecruit.do"
						...
						<table class="table">
							...
							<tr>
								<td>제목</td>
								<td><input type="text" value="${recruit.title}"
									style="border: none;" name="title" /></td>
							</tr>
							<tr>
								<td>내용</td>
								<td><textarea name="content" id="content" rows="15"
										style="width: 100%;">${ recruit.content}</textarea></td>
							</tr>
						</table>
						<div class="text-center">
							<button id="updateBtn" class="btn "
								style="margin-top: 50px; background-color: #00c89e; font-size: 18px; color: white;">
								수정</button>
						</div>
					</form>
				</div>
