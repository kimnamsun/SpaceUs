		...
		<div id="profileEditPage" class="ml-5 mr-5">
			<div class="card p-5">
				<div class="card-body">
					...
					<table class="col-11">
						<tr>
							<th class="align-baseline">닉네임 <i
								class="fa fa-check nickNameCheck ml-2"
								style="display: none; color: #3ab549;" aria-hidden="true"></i> <i
								class="fa fa-close nickNameFalse ml-2"
								style="display: none; color: red;" aria-hidden="true"></i></th>
							<th><input type="hidden" id="memberName"
								value="${ member.nickName }" /> <input type="text" id="nickName"
								class="col-7 input-group-text mb-4 mr-5 pull-right"
								style="background-color: white;" value="${ member.nickName }"
								required /></th>
						</tr>
						<tr>
							<td class="align-baseline">이메일 계정</td>
							<td><input type="email" id="memberEmail"
								class="col-7 input-group-text mb-4 mr-5 pull-right"
								value="${ member.memberEmail}" disabled /></td>
						</tr>
						<tr>
							<td class="align-baseline">생일</td>
							<td><input type="text"
								class="col-7 input-group-text mb-4 mr-5 pull-right"
								value="${member.birthDay}" disabled /></td>
						</tr>
						<tr>
							<td class="align-baseline">핸드폰 <i
								class="fa fa-check phoneCheck ml-2"
								style="display: none; color: #3ab549;" aria-hidden="true"></i> <i
								class="fa fa-close phoneFalse ml-2"
								style="display: none; color: red;" aria-hidden="true"></i></td>
							<td>
								<div class="row" style="margin-right: 50px;">
									<input type="hidden" id="memberPhone"
										value="${ member.memberPhone }" /> <input type="tel"
										id="phone" class="col-5 input-group-text mb-4 ml-auto mr-5"
										style="background-color: white;" maxlength="11"
										value="${ member.memberPhone}" required />
									<div class="btn-wrap">
										<button class="btn btn-primary font-bold phone-btn">휴대폰
											인증</button>
									</div>
								</div>
								<div id="certification" class="row"
									style="margin-right: 52px; display: none;">
									<input id="phoneChk"
										class="col-5 input-group-text mb-4 ml-auto mr-5"
										style="background-color: white;" type="number" id="phoneChk"
					...
					<div class="mt-5 mr-5"
						...
						<input type="submit" class="btn primary-btn p-3 pl-4 pr-4"
							id="infoUpdate" value="회원정보 수정">&nbsp; <input
							type="reset" id="resetBtn"
							class="btn btn-outline-secondary mr-5 btn-lg p-3 pl-4 pr-4 font-weight-bolder"
							style="width: 128.23px; cursor: default;" value="변경사항 없음">
					</div>
					...
					<table class="col-11">
						<tr>
							...
							<td><input type="password" id="password"
								class="col-8 input-group-text ml-auto mb-4 mr-5"
								style="background-color: white;" value="" /></td>
						</tr>
						<tr>
							<td class="align-baseline">새 비밀번호 확인 <i
								class="fa fa-check passwordCheck ml-2"
								style="display: none; color: #3ab549;" aria-hidden="true"></i> <i
								class="fa fa-close passwordFalse ml-2"
								style="display: none; color: red;" aria-hidden="true"></i></td>
							<td><input type="password" id="passwordChk"
								class="col-8 input-group-text ml-auto mb-5 mr-5"
								style="background-color: white;" value="" required /></td>
						</tr>
					</table>
					<div class="mt-5 pull-right mr-5">
						<input type="submit" id="updatePwd"
							class="btn primary-btn p-3 pl-4 pr-4" value="비밀번호 수정">&nbsp;
						<input type="reset" id="pwdReset"
							class="btn btn-outline-secondary mr-5 btn-lg p-3 pl-4 pr-4 font-weight-bolder"
							style="width: 128.23px; cursor: default;" value="변경사항 없음">
					</div>
				</div>
				<div class="container-fluid mt-4 pr-5"
					style="min-height: calc(10vh - 136px);">
					<div class="panel panel-default">
						<div class="panel-heading" role="tab">
							<a role="button" id="deleteTitle" data-toggle="collapse"
								data-parent="#accordion" href="#collapse1" aria-expanded="false"
								style="color: #666;"> 탈퇴하기 </a>
						</div>
						<div id="collapse1" class="panel-collapse collapse mr-5"
							role="tabpanel">
							<br />
							<div class="panel-body">
								탈퇴하시면 모든 정보가 삭제됩니다.<br />정말로 탈퇴하시겠습니까?
							</div>
							<button onclick="$('#deleteTitle').trigger('click');"
								class="btn btn-outline-secondary font-bold mr-3 pull-right">취소</button>
							<button id="deleteBtn"
								class="btn btn-danger font-bold mr-2 pull-right">확인</button>
							<form
