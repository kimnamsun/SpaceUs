...
<body
	style="background-color: #f7f7f7; overflow-x: hidden; overflow-y: hidden;">

	<div class="limiter">
		<div class="container-login100">
			<form:form
				action="${pageContext.request.contextPath}/member/sendMail.do"
				method="post">
				<div class="wrap-login100" style="padding: 50px; padding-top: 20px">
					...
					<div class="wrap-input100 validate-input"
						...
						<input class="input100" type="email" name="tomail"
							placeholder="email"> <span class="focus-input100">email</span>
						<span class="focus-output100"></span>
					</div>

					<div class="text-left p-b-20" style="width: 99%">
						<p class="txt1">가입 시 사용한 이메일 주소를 입력해주시면 임시비밀번호를 메일로 보내드립니다.</p>
						<br />
					</div>
					<div class="container-login100-form-btn">
						<button type="submit" class="login100-form-btn">임시 비밀번호
							전송</button>
					</div>
				</div>
			</form:form>
