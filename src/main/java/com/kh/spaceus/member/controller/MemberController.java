...
public class MemberController {
	...
	public String deleteMember(@RequestParam("memberEmail") String memberEmail, RedirectAttributes redirectAttr,
	...
	@ResponseBody
	public ModelAndView insertStamp(ModelAndView mav, @RequestParam("memberEmail") String email) {
	...
	public String mailSending(HttpServletRequest request, RedirectAttributes redirectAttr,
		...
		String content = "<div style=\"display: block; margin: 30px;\"><img src=\"https://i.imgur.com/NBgCFoR.png\" width=\"66\" height=\"66\" /></div>\r\n"
				...
				+ "<td style=\"height: 52.9px;\"><strong><span style=\"color: #ffffff; font-family: Montserrat-Bold;\">새로운 비밀번호: "
				+ newPassword + "</span></strong></td>\r\n" + "</tr>\r\n" + "<tr style=\"height: 18px;\">\r\n"
				+ "<td style=\"height: 18px;\">&nbsp;</td>\r\n" + "</tr>\r\n"
				+ "<tr style=\"height: 18px;\" align=\"center\">\r\n"
	...
	public String insertReview(Review review, @RequestParam("spaceNo") String spaceNo,
		...
		String saveDirectory = request.getServletContext().getRealPath("/resources/upload/review");
	...
	public String updateReview(Review review, @RequestParam("spaceNo") String spaceNo,
			@RequestParam("revNo") String revNo, HttpServletRequest request, RedirectAttributes redirectAttr) {
	...
	@ResponseBody
	public Map<String, Object> updateMember(ModelAndView mav, Member member) {
	...
	@ResponseBody
	public ModelAndView updatePwd(ModelAndView mav, Principal principal, Member member) {
