...
public class HostController {
	...
	public String updateSpace(@RequestParam String optionNo, @RequestParam String day, @RequestParam String status,
	...
	public String reviewList(Principal principal, Model model, HttpServletRequest request,
			@RequestParam(defaultValue = "1", value = "cPage") int cPage) {
		final int limit = 10;
		int offset = (cPage - 1) * limit;
		Space space = spaceService.selectOneSpaceNo(principal.getName());
	...
	public ModelAndView selectReviewComment(ModelAndView mav, @RequestParam("spaceNo") String spaceNo,
			@RequestParam(defaultValue = "1", value = "cPage") int cPage) {
	...
	public ModelAndView updateReviewComment(ModelAndView mav, @RequestParam("content") String content,
