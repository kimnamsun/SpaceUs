...
public class ReservationController {
	...
	public String insertReservation(Model model, Reservation reservation, @RequestParam("couponNo") String couponNo,
	...
	public String payment(Reservation reservation, @RequestParam("couponNo") String couponNo,
